<template>
  <el-container>
    ...
    <el-dialog title="修改店铺消息" :visible.sync="dialogVisible" width="600px" :before-close="handleClose">
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="店铺介绍" prop="intro">
          <el-input v-model.number="ruleForm.intro"></el-input>
        </el-form-item>
        <el-form-item label="联系电话" prop="phone">
          <el-input v-model.number="ruleForm.phone"></el-input>
        </el-form-item>
        <el-form-item label="店铺分类" prop="classify">
          <el-input v-model.number="ruleForm.classify"></el-input>
        </el-form-item>
        <el-form-item label="商铺图片" prop="pic">
          <el-input v-model.number="ruleForm.pic"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="sendModifyMsg, dialogVisible = false">确 定</el-button>
      </span>
    </el-dialog>
  </el-container>
</template>
